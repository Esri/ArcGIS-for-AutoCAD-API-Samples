...
5. If building on a machine that does not have Civil 3D 2026 installed, update the project file ItemGroup where that version is referenced. (If Civil 3D is not installed, omit the ItemGroup and remove the Alignment to M-Aware Line sample to avoid build errors.)
